...
import { WorkEvent } from "../imports/collections/sensors.js";
...
var tempFunc = function(){
  ...
  createStoryJS({
    ...
    width: '100%',
    height: '400',
    source: '/model.json', // time line source , JSON
...
Template.history.onCreated(function() {
  ...
  self.autorun(function() {
    Meteor.subscribe("devicedatas");  //for IMPACT
...
/*Template.history.helpers({
  devicedatas: function() {
    ...
    var dataset = DeviceDetails.find().fetch();

    var resource = dataset.map(function(d) {
