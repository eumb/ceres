...
Template.administration.onCreated(function() {
  ...
  self.autorun(function() {
    ...
    subscriptions.subscribe('sensortelemetries');
  });
  ...
  GoogleMaps.ready("sensorMap", function(map) {
    ...
    Tracker.autorun(function() {
      ...
      var locationS2 = SensorTelemetry.findOne({
        nodename: "Senzor_2",
        lat: { $exists: true }
      });
      // var locationS3 = SensorTelemetry.findOne({nodename:"Senzor_3",'lat':{$exists:true}});
      var locationS4 = SensorTelemetry.findOne({
        nodename: "Senzor_4",
        lat: { $exists: true }
      });
...
Template.administration.helpers({
  ...
  sensordescriptionS3: function() {
    var data = SensorTelemetry.findOne(
      { nodename: "Senzor_3", batt_level: { $exists: true } },
      { sort: { created_at: -1 } }
    );
  ...
  sensortelemetrymemS3: function() {
    ...
    return SensorTelemetry.find(
      { nodename: "Senzor_3", free_mem: { $exists: true } },
      { sort: { created_at: -1 }, limit: 1 }
    ).fetch();
  },
  sensortelemetrygpsS3: function() {
    ...
    return SensorTelemetry.find(
      { nodename: "Senzor_3", lat: { $exists: true } },
      { sort: { created_at: -1 }, limit: 1 }
    ).fetch();
  },
  ...
  sensordescriptionS1: function() {
    var data = SensorTelemetry.findOne(
      { nodename: "Senzor_1", batt_level: { $exists: true } },
      { sort: { created_at: -1 } }
    );
  ...
  sensortelemetrymemS1: function() {
    ...
    return SensorTelemetry.find(
      { nodename: "Senzor_1", free_mem: { $exists: true } },
      { sort: { created_at: -1 }, limit: 1 }
    ).fetch();
  },
  sensortelemetrygpsS1: function() {
    //console.log(SensorTelemetry.find({'nodename':"Senzor_1",'lat':{$exists:true}},{sort: {'created_at' : -1},limit:1}).fetch());
    return SensorTelemetry.find(
      { nodename: "Senzor_1", lat: { $exists: true } },
      { sort: { created_at: -1 }, limit: 1 }
    ).fetch();
  },
  ...
  sensordescriptionS2: function() {
    var data = SensorTelemetry.findOne(
      { nodename: "Senzor_2", batt_level: { $exists: true } },
      { sort: { created_at: -1 } }
    );
  ...
  sensortelemetrymemS2: function() {
    ...
    return SensorTelemetry.find(
      { nodename: "Senzor_2", free_mem: { $exists: true } },
      { sort: { created_at: -1 }, limit: 1 }
    ).fetch();
  },
  sensortelemetrygpsS2: function() {
    ...
    return SensorTelemetry.find(
      { nodename: "Senzor_2", lat: { $exists: true } },
      { sort: { created_at: -1 }, limit: 1 }
    ).fetch();
  },
  ...
  sensordescriptionS4: function() {
    var data = SensorTelemetry.findOne(
      { nodename: "Senzor_4", batt_level: { $exists: true } },
      { sort: { created_at: -1 } }
    );
  ...
  sensortelemetrymemS4: function() {
    ...
    return SensorTelemetry.find(
      { nodename: "Senzor_4", free_mem: { $exists: true } },
      { sort: { created_at: -1 }, limit: 1 }
    ).fetch();
  },
  sensortelemetrygpsS4: function() {
    ...
    return SensorTelemetry.find(
      { nodename: "Senzor_4", lat: { $exists: true } },
      { sort: { created_at: -1 }, limit: 1 }
    ).fetch();
  },
  ...
  sensordescriptionS5: function() {
    var data = SensorTelemetry.findOne(
      { nodename: "Senzor_5", batt_level: { $exists: true } },
      { sort: { created_at: -1 } }
    );
  ...
  sensortelemetrymemS5: function() {
    //console.log(SensorTelemetry.find({'nodename':"Senzor_3",'free_mem':{$exists:true}},{sort: {'created_at' : -1},limit:1}).fetch());
    return SensorTelemetry.find(
      { nodename: "Senzor_5", free_mem: { $exists: true } },
      { sort: { created_at: -1 }, limit: 1 }
    ).fetch();
  },
  sensortelemetrygpsS5: function() {
    //console.log(SensorTelemetry.find({'nodename':"Senzor_3",'lat':{$exists:true}},{sort: {'created_at' : -1},limit:1}).fetch());
    return SensorTelemetry.find(
      { nodename: "Senzor_5", lat: { $exists: true } },
      { sort: { created_at: -1 }, limit: 1 }
    ).fetch();
  },
